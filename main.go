...
func main() {
	...
	api := router.Group("/api")
	{
		...
		admin.Use(middleware.JWTMiddleware())
		{
			...
			admin.GET("/subcatelog/:catelogId", handler.GetSubCatelogsByCatelogHandler)
			admin.POST("/subcatelog", handler.AddSubCatelogHandler)
			admin.PUT("/subcatelog/:id", handler.UpdateSubCatelogHandler)
			admin.DELETE("/subcatelog/:id", handler.DeleteSubCatelogHandler)
			admin.PUT("/subcatelogs/sort", handler.UpdateSubCatelogSortHandler)
		}
	}
